...
function QuizApplication(qaArray) {
  ...
  this.attachListeners = function () {
    ...
    for (
      let index = 0;
      index < questionAnswerObj.answerChoicesObj.length;
      index++
    ) {
  ...
  this.displayQASection = function () {
    ...
    for (let index = 0; index < answerChoicesObj.length; index++) {
      ...
      const answerChoiceHtmlElement = document.getElementById(
        answerChoiceHtmlElementName
      );
